...
object LayoutBuilder {
    fun build(parent: LinearLayout, data: SurveyQuestion, layoutInflater: LayoutInflater, onInit: (String, Any?, MaterialCardView, Map<String, TextView>?, CompoundButton?, GoogleMap?) -> Unit, onSelected: (String, Any?) -> Unit){
        data.apply{
            when(type){
                QuestionType.DOUBLE_BOX -> {
                    ...
                    options?.forEach { item ->
                        ...
                        onInit(data.field,item.value,cardView, null, null, null)
                ...
                QuestionType.MULTI_CHECKBOX -> {
                    ...
                    options?.forEach { item ->
                        ...
                        onInit(data.field,item.value,cardView, null, checkBox, null)
                ...
                QuestionType.MULTI_RADIO -> {
                    ...
                    options?.forEach { item ->
                        ...
                        onInit(data.field,item.value,cardView, null, radioButton, null)
